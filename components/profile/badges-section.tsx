...
const BADGE_INFO: Record<string, { description: string; rarity: 'common' | 'rare' | 'epic' | 'legendary' }> = {
  ...
  'Security Expert': { description: 'Passed all security challenges', rarity: 'epic' },
...
const RARITY_COLORS = {
  ...
  legendary: 'bg-yellow-500/20 border-yellow-500/50 text-yellow-300 hover:bg-yellow-500/30',
};
