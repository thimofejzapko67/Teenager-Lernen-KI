  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group relative overflow-hidden rounded-3xl bg-background border border-border/40 p-6 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1",
